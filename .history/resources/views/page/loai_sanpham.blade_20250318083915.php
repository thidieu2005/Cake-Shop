            ...
            <div class="row">
                <div class="col-sm-3">
                    <ul class="aside-menu">
                        ...
                        <li><a href="{{route('type-product', $lsp->id)}}">{{$lsp->name}}</a></li>
                        @endforeach
                    </ul>
                </div>
                <div class="col-sm-9">
                            ...
                            <div class="col-sm-4">
                                <div class="single-item">
                                    ...
                                    <div class="single-item-header">
                                        <a href="product.html"><img width="200" height="200" src="/source/image/product/{{$sp->image}}" alt=""></a>
                                    </div>
                    ...
                    <div class="beta-products-list">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="single-item">
                                    <div class="single-item-header">
                                        <a href="product.html"><img width="200" height="200" src="/source/image/product/{{$sp_khac->image}}" alt=""></a>
                                    </div>
                                    <div class="single-item-body" style="font-size: 18px">
